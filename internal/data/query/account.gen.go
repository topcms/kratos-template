...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.UserPwd = field.NewString(tableName, "user_pwd")
	_account.LoginNum = field.NewInt32(tableName, "login_num")
	_account.Salt = field.NewString(tableName, "salt")
	_account.Salt2 = field.NewString(tableName, "salt2")
	_account.State = field.NewInt32(tableName, "state")
	_account.CreatedBy = field.NewString(tableName, "created_by")
...
type account struct {
	...
	Salt      field.String // 主加密key
	Salt2     field.String // 二次加密key
...
func (a *account) updateTableName(table string) *account {
	...
	a.UserPwd = field.NewString(table, "user_pwd")
	a.LoginNum = field.NewInt32(table, "login_num")
	a.Salt = field.NewString(table, "salt")
	a.Salt2 = field.NewString(table, "salt2")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["user_pwd"] = a.UserPwd
	a.fieldMap["login_num"] = a.LoginNum
	a.fieldMap["salt"] = a.Salt
	a.fieldMap["salt2"] = a.Salt2
