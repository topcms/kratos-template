...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserCode = field.NewString(tableName, "user_code")
	...
	_user.UserDesc = field.NewString(tableName, "user_desc")
	...
	_user.DeptCode = field.NewString(tableName, "dept_code")
	_user.Avatar = field.NewString(tableName, "avatar")
	_user.AvatarThumb = field.NewString(tableName, "avatar_thumb")
	_user.IsAccount = field.NewInt32(tableName, "is_account")
...
type user struct {
	...
	UserDesc    field.String // 个人描述
	Email       field.String // 邮箱
	Gender      field.Int32  // 性别
	Tel         field.String // 固定电话
	Mobile      field.String // 手机号码
	DeptCode    field.String // 所属部门
	Avatar      field.String // 头像
	AvatarThumb field.String // 头像缩略图
	IsAccount   field.Int32  // 账号标识
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserDesc = field.NewString(table, "user_desc")
	u.Email = field.NewString(table, "email")
	u.Gender = field.NewInt32(table, "gender")
	u.Tel = field.NewString(table, "tel")
	u.Mobile = field.NewString(table, "mobile")
	u.DeptCode = field.NewString(table, "dept_code")
	u.Avatar = field.NewString(table, "avatar")
	u.AvatarThumb = field.NewString(table, "avatar_thumb")
	u.IsAccount = field.NewInt32(table, "is_account")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_desc"] = u.UserDesc
	u.fieldMap["email"] = u.Email
	u.fieldMap["gender"] = u.Gender
	u.fieldMap["tel"] = u.Tel
	u.fieldMap["mobile"] = u.Mobile
	u.fieldMap["dept_code"] = u.DeptCode
	u.fieldMap["avatar"] = u.Avatar
	u.fieldMap["avatar_thumb"] = u.AvatarThumb
	u.fieldMap["is_account"] = u.IsAccount
