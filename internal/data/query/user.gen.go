...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.RegType = field.NewInt32(tableName, "reg_type")
	_user.RegTime = field.NewTime(tableName, "reg_time")
	_user.RegIP = field.NewInt32(tableName, "reg_ip")
	...
	_user.IsDel = field.NewInt32(tableName, "is_del")
...
type user struct {
	...
	UserCode     field.String // 用户code(显示ID)
	UserName     field.String // 用户名
	Avatar       field.String // 头像
	Gender       field.Int32  // 性别(0:未知,1:男,2:女)
	Introduction field.String // 简介
	RegType      field.Int32  // 注册类型
	RegTime      field.Time   // 注册时间
	RegIP        field.Int32  // 注册IP
...
func (u *user) updateTableName(table string) *user {
	...
	u.RegType = field.NewInt32(table, "reg_type")
	u.RegTime = field.NewTime(table, "reg_time")
	u.RegIP = field.NewInt32(table, "reg_ip")
