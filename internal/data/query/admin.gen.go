...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.Role = field.NewString(tableName, "role")
	_admin.LastLoginTime = field.NewString(tableName, "last_login_time")
	_admin.LastLoginIP = field.NewString(tableName, "last_login_ip")
	_admin.Domain = field.NewString(tableName, "domain")
...
type admin struct {
	...
	LastLoginTime field.String // 上次登录时间
	LastLoginIP   field.String // 上次登录ip
	Domain        field.String // 域
	Status        field.Bool   // 状态0冻结1正常
