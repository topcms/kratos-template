...
func newDictionary(db *gorm.DB, opts ...gen.DOOption) dictionary {
	...
	_dictionary.DictCode = field.NewString(tableName, "dict_code")
	_dictionary.DictName = field.NewString(tableName, "dict_name")
	_dictionary.DictType = field.NewInt64(tableName, "dict_type")
	_dictionary.Status = field.NewInt32(tableName, "status")
	_dictionary.Sort = field.NewInt32(tableName, "sort")
	_dictionary.CreatedAt = field.NewTime(tableName, "created_at")
	_dictionary.UpdatedAt = field.NewTime(tableName, "updated_at")
	_dictionary.IsDel = field.NewInt32(tableName, "is_del")
...
type dictionary struct {
	...
	ALL       field.Asterisk
	ID        field.Int64  // 字典ID
	DictCode  field.String // 字典code(外显)
	DictName  field.String // 字典名称
	DictType  field.Int64  // 字典类型ID
...
func (d *dictionary) updateTableName(table string) *dictionary {
	...
	d.DictCode = field.NewString(table, "dict_code")
	d.DictName = field.NewString(table, "dict_name")
	d.DictType = field.NewInt64(table, "dict_type")
